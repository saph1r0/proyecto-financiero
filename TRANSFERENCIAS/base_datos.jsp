...
public boolean insCliente (String monto, String origen, String propia, String terceros, String concepto, String notif) throws IOException, SQLException { //, String terms
    try {
        PreparedStatement ps = this.conexion.prepareStatement ("INSERT INTO tdirecta VALUES (" + monto +","+ origen+","+propia+","+terceros+",'"+concepto+"','"+notif+"')");
        ps.execute();
    } catch (SQLException ex) {
        return false;
    }
